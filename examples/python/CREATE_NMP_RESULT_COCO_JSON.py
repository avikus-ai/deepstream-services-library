...
coco_json = []
folder_name = 'FLL_221022_DGPU'

video_source_path = \
    '../../../datas/sample_video/new_fll_val.mp4'

# Preprocessor config file is located under "/deepstream-services-library/test/configs"
preproc_config_file = \
    f'../../../datas/{folder_name}/config_preprocess_v5s.txt'

# Filespecs for the Primary GIE
primary_infer_config_file = \
    f'../../../datas/{folder_name}/config_infer_primary_yoloV5s.txt'
...
primary_model_engine_file = \
    f'../../../datas/{folder_name}/model_b1_gpu0_fp16.engine'

nmp_label_file = \
    f'../../../datas/{folder_name}/labels_aiboat.txt'
...
def main(args):
    ...
    while True:
        ...
        retval = dsl_source_file_new('video-source', video_source_path, False)
...
#             break
        ...
        retval = dsl_sink_file_new('file-sink', "./output.mp4", DSL_CODEC_H264, DSL_CONTAINER_MP4, 8000000, 0)
        if retval != DSL_RETURN_SUCCESS:
            break
...
#             'preprocessor', 
    ...
    save_dir = Path('.')
    save_path = str(save_dir / "result_FL221022_0.25_standard_pred.json")
    save_json(save_path)
